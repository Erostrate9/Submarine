...
public class Constants {
    ...
    public static final String APP_ID = "BwdCsrZkJv73JwngASdz858HDd4hwb5Qup2TSoetr8LU";
    public static final String SDK_KEY = "5h1VQbnoNneaybrD9syTeViqA9BNuMEtks3VVMDjHXCL";
